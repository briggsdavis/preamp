...
function EditorControls({
  ...
  return (
    <div className="absolute inset-x-2 top-2 z-50 flex items-center justify-between gap-1 opacity-0 transition-none group-hover:opacity-100 group-focus-within:opacity-100">
      <EditableLink
