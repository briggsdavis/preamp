...
import { EditableImage, EditableText, useInlineEditingMode } from "@/components/cms/inline-editing"
...
export function ParallaxBanner({
  ...
  return (
    ...
    >
      ...
      >
        {kicker && (
          <p className="font-groovy text-sm tracking-[0.4em] text-amber uppercase">
