...
import { imageUrl, useGlobalContent, useHomeContent } from "@/lib/site-content"
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 className="mt-6 max-w-2xl font-groovy text-lg tracking-[0.18em] text-cream/90 uppercase md:text-xl">
