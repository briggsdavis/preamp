...
import { COLD_BREW_ICON_OPTIONS } from "@/components/site/content-icon"
...
import { fillTemplate, imageUrl, useCmsContent, useGlobalContent } from "@/lib/site-content"
...
function ComingSoonCard({
  ...
  return (
    ...
    >
      <span className="absolute top-4 right-4 rounded-full bg-gold/20 px-3 py-1 font-groovy text-[0.65rem] tracking-[0.15em] text-gold uppercase">
        ...
        <div className="relative mx-auto max-w-3xl px-6 text-center md:px-8">
          ...
          >
            ...
            <p className="mt-5 text-lg text-espresso/80">
              <EditableText
                path="availability.body"
                value={fillTemplate(content.availability.body, global)}
              />
            </p>
          </motion.div>
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            ...
            <EditableLink
              path="availability.directionsButton"
              value={content.availability.directionsButton}
            >
              <a
