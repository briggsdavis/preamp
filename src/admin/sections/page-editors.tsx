...
import { LoadingEditor, useCmsEditor } from "@/admin/cms-editor-kit"
import { useUpload } from "@/admin/use-upload"
import { InlineEditingProvider, preventCanvasInteraction } from "@/components/cms/inline-editing"
import { GlobalContentProvider } from "@/lib/site-content"
import { CmsContentPreviewProvider, type CmsKey } from "@/lib/site-content"
...
const ColdBrewPage = lazy(() =>
  import("@/pages/cold-brew").then((module) => ({ default: module.ColdBrew })),
)
