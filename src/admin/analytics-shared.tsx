...
export const PIE = [C.gold, C.terracotta, C.amber, C.brick, C.orange, C.maroon, "#3b2417", C.sand]
...
export function CardTitle({ children }: { children: ReactNode }) {
  return (
    <h2 className="font-groovy text-sm tracking-[0.2em] text-terracotta uppercase">{children}</h2>
  )
}
