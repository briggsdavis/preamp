...
export function EditorShell({
  ...
  return (
    <div className="mx-auto max-w-[1380px]">
      <div className="sticky top-0 z-40 -mx-3 mb-7 flex flex-wrap items-center justify-between gap-4 border-b-2 border-sand bg-cream-deep/95 px-3 pb-5 pt-1 backdrop-blur-md">
        <div>
    ...
    <div className="grid items-start gap-6 xl:grid-cols-[minmax(0,1.45fr)_minmax(340px,0.65fr)]">
      <div className="overflow-hidden rounded-lg border-2 border-sand bg-cream shadow-sm">
        <div className="flex items-center justify-between border-b border-sand bg-white px-4 py-2.5">
          <p className="text-xs font-bold uppercase tracking-[0.16em] text-espresso/55">
            Live preview
          </p>
